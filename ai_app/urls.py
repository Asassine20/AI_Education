...
urlpatterns = [
    ...
    path('dashboard/course/<str:room_code>/assignment/<int:assignment_id>/question_page', question_page, name='question_page'),
    path('dashboard/course/<str:room_code>/assignment/<int:assignment_id>/set_access/', set_access, name='set_access'),
